...
impl_tokenize!(syntax::InterpolationQualifier, tokenize_interpolation_qualifier);
...
impl_tokenize!(syntax::PreprocessorVersionProfile, tokenize_preprocessor_version_profile);
